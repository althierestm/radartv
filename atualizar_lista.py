...
def obter_stream_iblups():
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=10) as response:
            ...
            # Procura por qualquer URL .m3u8 dentro do player
            ...
            # Busca por links HLS alternativos
...
def create_m3u():
    ...
    if stream_live:
        ...
        # Parâmetros de cabeçalho para autorização nos aplicativos de IPTV
        user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"
        referer = "https://iblups.com/"
        headers_pipe = f"|User-Agent={user_agent}&Referer={referer}"
        ...
        m3u_content += f'{stream_live}{headers_pipe}\n'
    else:
    ...
    print("✅ Arquivo lista.m3u atualizado com sucesso!")
